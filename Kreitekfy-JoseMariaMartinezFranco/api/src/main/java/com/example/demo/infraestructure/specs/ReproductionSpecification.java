...
public class ReproductionSpecification extends EntitySpecification<Reproduction> implements Specification<Reproduction> {

    public ReproductionSpecification(List<SearchCriteria> criteria) {
